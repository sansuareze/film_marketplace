...
equipment1 = Equipment.new(daily_price: 100, title: "Camera", description: "Such a great one. Please rent it from me", category: "Camera", state: "New", user: user1, address: "Hochallee 42, 20149 Hamburg")
...
equipment2 = Equipment.new(daily_price: 75, title: "Tripod", description: "You can use it to mount your camera", category: "Supports", state: "New", user: user1, address: "Heilwigstraße 71, 20249 Hamburg")
...
equipment3 = Equipment.new(daily_price: 75, title: "Lighting Set", description: "You can use it to give light to your set", category: "Lighting", state: "Decayed", user: user2, address:  "Heilwigstraße 71, 20249 Hamburg")
...
equipment4 = Equipment.new(daily_price: 125, title: "Camera Lenses", description: "You can use them to improve your camera's image quality", category: "Lenses", state: "New", user: user3, address: "Oberstraße 42, 20144 Hamburg")
...
equipment5 = Equipment.new(daily_price: 200, title: "Shotgun Microphone", description: "Best way to add sound to your film", category: "Sound", state: "Decayed", user: user3, address: "Isestraße 3, 20144 Hamburg")
...
equipment6 = Equipment.new(daily_price: 200, title: "Boom Pole", description: "Good microphone to be able to add sound to your film", category: "Sound", state: "Used", user: user1, address: "Isestraße 3, 20144 Hamburg")
